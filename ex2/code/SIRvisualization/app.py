            ...
            dbc.Row([
                ...
                dbc.Col([
                     dcc.Input(id='input-folder-path', type='text', size='200',
                               value=r'D:\study-TUM\23ss\praktikum\ex02\task4\SIRvisualization\output',
                               placeholder='D:\study-TUM\23ss\praktikum\ex02\task4\SIRvisualization\output', debounce=True)
                ])
                ]),
            dbc.Row([
                dbc.Col([
